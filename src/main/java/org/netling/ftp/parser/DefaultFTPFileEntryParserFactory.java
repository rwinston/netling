 ...
 * org.netling.ftp.FTPClient.listFiles()
 * if no other implementation has been specified.
 *
 * @see org.netling.ftp.FTPClient#listFiles
 * @see org.netling.ftp.FTPClient#setParserFactory
 */
    ...
    public FTPFileEntryParser createFileEntryParser(String key)
    {
        ...
        catch (ClassCastException e)
        {
            throw new ParserInitializationException(parserClass.getName()
                ...
                + "org.netling.ftp.FTPFileEntryParser.", e);
        }
        catch (Throwable e)
        {
            throw new ParserInitializationException("Error initializing parser", e);
