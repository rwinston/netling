...
{
    static final boolean noConversionRequired;
    static final String lineSeparator;
    static final byte[] lineSeparatorBytes;

    static {
        lineSeparator = System.getProperty("line.separator");
        noConversionRequired = lineSeparator.equals("\r\n");
    ...
    {
        super(input, lineSeparatorBytes.length + 1);
    }
    ...
    /**
     * Check that the input stream is still valid
     * @throws IOException
     */
