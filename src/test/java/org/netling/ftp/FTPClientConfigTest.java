...
public class FTPClientConfigTest {
	...
	public void testFTPClientConfigString() {
		...
		assertEquals(config.getDefaultDateFormatStr(), null);
		assertEquals(config.getRecentDateFormatStr(), null);
		assertEquals(config.getShortMonthNames(), null);
		assertEquals(config.getServerTimeZoneId(), null);
		assertEquals(config.getServerLanguageCode(), null);
	}
