...
public class NTFTPEntryParserTest extends CompositeFTPParseTestFramework
{
    ...
    /**
     * @see org.netling.ftp.parser.CompositeFTPParseTestFramework#getGoodListings()
     */
    @Override
    ...
    /**
     * @see org.netling.ftp.parser.CompositeFTPParseTestFramework#getBadListings()
     */
    @Override
    ...
    protected void doAdditionalGoodTests(String test, FTPFile f)
    {
        if (test.indexOf("<DIR>") >= 0)
        {
                    assertEquals("directory.type",
                            FTPFile.Type.DIRECTORY, f.getType());
        }
    }
